        ...
        BACKGROUND.getServerSettings(function(server) {
            $.post(server.url + "/login", loginData, "json")
                .done(function (result, status) {
                    ...
                    $(".js-FAQ-container").html('<a role="button" class="btn btn-primary" target="_blank" href="https://confluence.walmart.com/display/LABS/Product+Tagging+Helper+%28Chrome+Extension%29+-+FAQ">FAQ</a>')
